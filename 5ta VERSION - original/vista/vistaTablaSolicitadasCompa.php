...
$('document').ready(inicio);
	...
	function abrirFull(){
		alert('La cobertura ya está aceptada!');
		}	
</script>	
<div class="row">
	<div class="col-lg-12">
        <div class="panel panel-danger">
          ...
          <div class="panel-body">
            <p class="letraTabla">En la siguiente tabla se muestran todas las coberturas que fueron solicitadas por los client</p>
          </div>
        </div>
	</div>
</div>
...
<table class="table table-striped table-bordered table-hover">
    ...
    <?php 
      ...
      <tr>
        ...
        <td><a onclick="return confirm('Esta seguro que quiere aceptar esta cobertura?');" href="controladorAceptarCobertura.php?tipo=aceptar&nro=<?php echo $cobersoli['id_cobSolicitada']?>&ok=<?php echo $cobersoli['confirmada']?>" class="btn" style="background:#000; color:#FFF; margin-left:10px; font-weight:bold;">Aceptar</a></td>
        <?php } else {?>
        	<td><a href="#" class="ok"><span class="glyphicon glyphicon-check iconoTabla"></span></a></td>
        <?php } ?>    
      </tr> 
    <?php 
